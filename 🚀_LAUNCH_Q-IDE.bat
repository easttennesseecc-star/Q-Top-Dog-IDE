@echo off
REM Q-IDE ULTIMATE FLAWLESS LAUNCHER - WORKING VERSION
REM Fixed for Windows compatibility with no emoji filenames
...
echo ============================================================
echo.
echo          Q-IDE TOPDOG - PROFESSIONAL LAUNCHER
echo.
echo ============================================================
echo.
...
start "Q-IDE Frontend" cmd /k "npx vite --host 127.0.0.1 --port 1431"
timeout /t 7 /nobreak >nul
echo [OK] Frontend started on port 1431
